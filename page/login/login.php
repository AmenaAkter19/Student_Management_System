...
// Shothik path diye config file load kora
// ../../ er mane holo dui folder upore jao
include_once "../../config/config.php"; 

// layout_lib.php-er jonno-o shothik path use kora
// Ebong include_once use kora
include_once "../../layout/header_lib.php";

// Ekhon $db=new database() kaaj korbe karon config.php thikbhabe load hoyeche
$db=new database(); 
?>
