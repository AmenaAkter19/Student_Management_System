...
<div class="row" >
  <div class="col-md-3 about_profile" >
    <div class="profile_header" style="background-color: #0b48c3ff;">Student Profile</div>
  ...
  <div class="about_profile_body" style="text-align: center;">
    ...
    <div class="info_side">
      ...
      <table width="80%">
        <tr>
          <td class="td_profile1" style="background-color: #0b48c3ff;">Full Name:</td>
          <td class="td_profile2"><?php echo "$name" ?><br/></td>
        </tr>
         <tr>
          <td class="td_profile1"style="background-color: #0b48c3ff;">Nick:</td>
          <td class="td_profile2"><?php echo "$nick" ?></td>
        </tr>
        <tr>
          <td class="td_profile1"style="background-color: #0b48c3ff;">ID:</td>
