    ...
    <div class="boxz" >
        ...
        <div class="row" >
          <div class="col-md-6 border">
            <div class="box_header"style="background-color: #0b48c3ff;">
...
<!-- Start Academic Information -->
        ...
        <center>
        <button class="box_btn" name="insert" type="submit" id="insert_btn" style="background-color: #0b48c3ff;"><span class="glyphicon glyphicon-floppy-save"></span>Save Information</button>
        </center>
      </form>
