...
<nav class="nav-sidebar" >
      <ul class="nav">
        ...
        <li onclick="add_user()" class="nav_button"style="background-color: #0b48c3ff;"><span class='glyphicon glyphicon-plus' ></span> Add User</li>
        <div id="btn_sidebar">
        	<li onclick="get_user_list('all')" class="nav_button"style="background-color: #0b48c3ff;"><span class="glyphicon glyphicon-user"></span> All User List</li>
