...
<script type="text/javascript" src="layout/js/nav_bar_script.js"></script>
 <div class="navbar navbar-default" role="navigation" style="background-color: #0b48c3ff; position: auto; border-width: 0px 0px 1px 0px; border-color: rgba(0,0,0,0.2); padding: 10px;" >
        ...
        <ul class="nav navbar-nav navbar-left">  
          ...
          <button  class="btn_nav_toggle"><i class="fa fa-caret-down" id="icon_div"></i></button>
          </span> 
        
        
          <a class="" href="index.php"><span class="navbar-brand"  style="color:var(--font-color)"><font class="logo_title">NWU Student Management System</font></span></a>
          <span class="nev_bar_button_area">
             <!-- here button -->
           <!-- <button onclick="student_info_nav_bar()" class="btn_tab" style="margin-left: 30px;"><span class="glyphicon glyphicon-fire"></span> Student Quick Access</button>
           <button onclick="sms_state_nav()" class="btn_tab" style="margin-left: 30px;"><span class="glyphicon glyphicon-envelope"></span> SMS Statistics</button>
...
<script type="text/javascript">
  function action_side_bar(){
    ...
    if(class_name=='content'){
      // Ager else block-er code ekhane chole ashlo
      div.className = 'content_with_sidebar';
      icon_div.className='fa fa-times';
    }
    else{
      // Ager if block-er code ekhane chole ashlo
      div.className = 'content';
      icon_div.className='fa fa-bars';
    }
  }
